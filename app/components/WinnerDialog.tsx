  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full mx-4">
        <h2 id="winner-title" className="text-3xl font-bold text-center mb-4 text-green-600">
          🎉 Gratulerer! 🎉
        </h2>
        ...
        <div className="flex gap-3">
          <button
            ...
            aria-label={`Fjern ett lodd fra ${winnerName}`}
          ...
          <button
            ...
            aria-label={`Behold lodd for ${winnerName}`}
